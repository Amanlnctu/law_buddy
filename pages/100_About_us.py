...
team_members = [
    ...
    {"name": "Anushka Joshi", "role": "Backend Development", "image": "anushka.jpg" , "discription" :"Anushka handles the backend development, ensuring robust data processing and server-side operations."},
    {"name": "Ayushmaan Nema", "role": "Assistance with Backend", "image": "ayushman.jpg","discription":"Ayushmaan supports Anushka with backend tasks and helps in optimizing server performance."},
